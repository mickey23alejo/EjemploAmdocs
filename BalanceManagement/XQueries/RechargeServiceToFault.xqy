...
declare function local:rechargeServiceToFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RechargeServiceFault) ::) {
    <ns2:RechargeServiceFault>
        <ns2:Error>
            <ns1:code>
