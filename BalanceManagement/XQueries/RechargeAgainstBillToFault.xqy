...
declare function local:rechargeServiceToFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RechargeAgainstBillFault) ::) {
    <ns2:RechargeAgainstBillFault>
        <ns2:Error>
            <ns1:code>
...
local:rechargeServiceToFault($errorTrace)