...
declare function local:RetrieveSubscriberSubscriptionBalanceToFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RetrieveSubscriptionBalanceFault) ::) {
    <ns2:RetrieveSubscriptionBalanceFault>
        <ns2:Error>
            <ns1:code>
...
local:RetrieveSubscriberSubscriptionBalanceToFault($errorTrace)