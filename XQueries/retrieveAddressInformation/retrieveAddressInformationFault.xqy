...
declare function local:retrieveAddressInformationFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RetrieveAddressInformationFault) ::) {
    <ns2:RetrieveAddressInformationFault>
        <ns2:Error>
            <ns1:code>
...
local:retrieveAddressInformationFault($errorTrace)