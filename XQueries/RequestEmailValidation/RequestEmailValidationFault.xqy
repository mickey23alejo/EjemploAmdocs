...
declare function local:requestEmailValidationFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RequestEmailValidationFault) ::) {
    <ns2:RequestEmailValidationFault>
        <ns2:Error>
            <ns1:code>
...
local:requestEmailValidationFault($errorTrace)