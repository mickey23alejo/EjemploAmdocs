...
declare function local:retrieveDistrictsFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:RetrieveDistrictsFault) ::) {
    <ns2:RetrieveDistrictsFault>
        <ns2:Error>
            <ns1:code>
...
local:retrieveDistrictsFault($errorTrace)