...
declare function local:retrieveDistrictsFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:ValidateAddressFault) ::) {
    <ns2:ValidateAddressFault>
        <ns2:Error>
            <ns1:code>
