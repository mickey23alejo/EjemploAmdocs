...
declare function local:updateEmailValidationStatusToFault($errorTrace as element() (:: schema-element(ns1:errorTrace) ::)) as element() (:: schema-element(ns2:UpdateEmailValidationStatusFault) ::) {
    <ns2:UpdateEmailValidationStatusFault>
        <ns2:Error>
            <ns1:code>
...
local:updateEmailValidationStatusToFault($errorTrace)